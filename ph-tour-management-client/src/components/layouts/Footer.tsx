        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            <div className="flex justify-center items-center gap-2.5 text-foreground sm:justify-start">
              <Logo size="48" />
              <h3 className="text-2xl font-bold">Happy Tour</h3>
            </div>
              ...
              <ul className="mt-8 space-y-4 text-sm">
                ...
                <li>
                  <a
                    ...
                    href="#"
                  >
                    <span className="text-foreground transition group-hover:text-foreground/75">
                      Live Chat
                    </span>
              ...
              <ul className="mt-8 space-y-4 text-sm">
                <li>
                  ...
                  >
                    <svg
                      ...
                      className="size-5 shrink-0 text-foreground shadow-sm"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                      strokeWidth="2"
                    ...
                    <span className="flex-1 text-foreground">john@doe.com</span>
                  </a>
                </li>
                ...
                <li>
                  ...
                  >
                    ...
                    <span className="flex-1 text-foreground">0123456789</span>
                  </a>
                </li>
                ...
                <li className="flex items-start justify-center gap-1.5 ltr:sm:justify-start rtl:sm:justify-end">
                  ...
                  <address className="-mt-0.5 flex-1 text-foreground not-italic">
